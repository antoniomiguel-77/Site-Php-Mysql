...
<body>
    <div id="box_form">
        <h1 class="titulos" style="margin-left:10%;">Formulário de Postagem</h1>
        ...
        <div class="botoes">
            ...
            <a href="form_scriptcss.php" class="form_link" style="margin-left: 30px;">  Ir para form scriptcss&rarr;</a>
